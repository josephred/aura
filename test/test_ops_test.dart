...
void main() {
  ...
  testWidgets('Test OperationsDashboard', (tester) async {
    ...
    File(r'c:\github\aura\screenshots\18_panel_operaciones_admin.png').writeAsBytesSync(
      byteData!.buffer.asUint8List(),
    );

    print('CAPTURED OPERATIONS DASHBOARD!');
  });
}
